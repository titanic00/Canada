    ...
    (() => {
        ...
        $((() => {
            $(".header__search").on("click", (() => {
                if ($(window).width() < 768) $(".header__link").toggleClass("header__link--disabled");
                if ($(window).width() < 890) $(".header__inner").addClass("header__inner--block");
                $(".header__search--form").on("click", (() => {
                    if ($(".header__inner").hasClass("header__inner--block")) $(".header__inner").removeClass("header__inner--block");
                }));
            ...
            $(".header__form-close").on("click", (() => {
                ...
                if ($(".header__link").hasClass("header__link--disabled")) $(".header__link").toggleClass("header__link--disabled");
                if ($(".header__inner").hasClass("header__inner--block")) $(".header__inner").removeClass("header__inner--block");
            }));
            ...
            $(".header__account").on("click", (() => {
                if ($(event.target).hasClass("header__account--767px")) return;
                if (!$(".header__language--unfold").hasClass("header__menu--disabled")) $(".header__language--unfold").toggleClass("header__menu--disabled"); else if (!$(".header__weather--unfold").hasClass("header__menu--disabled")) $(".header__weather--unfold").toggleClass("header__menu--disabled");
                if ($(".header__language").hasClass("header__language--focused")) $(".header__language").toggleClass("header__language--focused"); else if ($(".header__weather").hasClass("header__weather--focused")) $(".header__weather").toggleClass("header__weather--focused");
            ...
            $(".header__language").on("click", (() => {
                if (!$(".header__account--unfold").hasClass("header__menu--disabled")) $(".header__account--unfold").toggleClass("header__menu--disabled"); else if (!$(".header__weather--unfold").hasClass("header__menu--disabled")) $(".header__weather--unfold").toggleClass("header__menu--disabled");
                if ($(".header__account").hasClass("header__account--focused")) $(".header__account").toggleClass("header__account--focused"); else if ($(".header__weather").hasClass("header__weather--focused")) $(".header__weather").toggleClass("header__weather--focused");
            ...
            $(".header__weather").on("click", (() => {
                if (!$(".header__account--unfold").hasClass("header__menu--disabled")) $(".header__account--unfold").toggleClass("header__menu--disabled"); else if (!$(".header__language--unfold").hasClass("header__menu--disabled")) $(".header__language--unfold").toggleClass("header__menu--disabled");
                if ($(".header__language").hasClass("header__language--focused")) $(".header__language").toggleClass("header__language--focused"); else if ($(".header__account").hasClass("header__account--focused")) $(".header__account").toggleClass("header__account--focused");
                $(".header__weather--unfold").toggleClass("header__menu--disabled");
                $(".header__weather").toggleClass("header__weather--focused");
            }));
            $(document).on("click", (() => {
                if ("header__account" !== event.target.classList[0] && "header__language" !== event.target.classList[0] && "header__weather" !== event.target.classList[0]) {
            ...
            if ($(window).width() < 1217) {
                if ($(".login").hasClass("login--membership")) return;
            ...
            if ($(window).width() < 450) $(".aside__list-item").toggleClass("aside__list-item--hover");
        }));
        window["FLS"] = true;
        isWebp();
    })();
